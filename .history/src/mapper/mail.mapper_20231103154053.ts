...
export class MailMapper {
    ...
    async getContactUsEmail() {
        this._SUBJECT_CONTENT = format(EmailMessaging.CONTACT_SUBJECT, this._subject)
        this._HTML_CONTENT = format(EmailMessaging.CONTACT_CONTENT_HTML);
        this._TEXT_CONTENT = format(EmailMessaging.CONTACT_CONTENT_TEXT);
    }
